...
framework**. `db.md` is the Base44-specific one (its exec tool, secret store, pre-configured
...
&lt;business&gt;. Then fetch and follow https://www.wix.com/skills/vibe-headless/platforms/db.md
