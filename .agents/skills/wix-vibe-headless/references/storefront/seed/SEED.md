...
// imageUrl must be the FINAL https://media.db.com/... url from the COMPLETED generate_image
...
// images: use the FINAL https://media.db.com/... url only (never a /__generating__/ placeholder)
