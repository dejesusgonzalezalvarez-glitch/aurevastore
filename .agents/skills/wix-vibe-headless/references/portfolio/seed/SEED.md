...
const summary = await seed.setupPortfolio(ctx, {
  ...
  projects: [
    { title: "Northwind Rebrand", description: "Full identity refresh for a logistics firm.",
      ...
      // them to Wix Media for you (portfolio binds by file id). Use the FINAL https://media.db.com/...
      ...
      coverImageUrl: "https://media.db.com/…",
      items: [{ sortOrder: 1, title: "Hero", imageUrl: "https://media.db.com/…" }] },
  ],
});
